...
def convert(amount, home_currency_code, location_currency_code):
    ...
    wishes to convert and returns the un-formatted version of the conversion"""
    ...
    if home_currency_code != location_currency_code:
        ...
        # Exception if website is unreachable.
...
def get_details(country_name):
    ...
    # If the country name isn't found in the file return an empty tuple.
    return tuple()
...
# #Country.format_currency(Country.self, amount)